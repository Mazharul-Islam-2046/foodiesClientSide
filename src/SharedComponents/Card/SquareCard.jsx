...
const SquareCard = memo(({ item }) => {
    ...
    return (
        <>
            <div className= "card aspect-square bg-base-100 shadow-md relative flex justify-center items-center  rounded-lg overflow-hidden cursor-grab active:cursor-grabbing"
